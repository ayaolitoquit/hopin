...
<body>
    ...
    <div class="main-content">
        <section class="idname container mb-3">
            ...
            <div class="idname container">
            <div>
              <div class="namee">
                <h2>Name:<span id="name"></span></h2>
                <a class="link-offset-2 link-offset-3-hover link-underline link-underline-opacity-0 link-underline-opacity-75-hover" href="#"><i class="fa-regular fa-pen-to-square"></i> Edit</a>
              </div>
            </div>
            </div>
        ...
        <section class="email container mb-3">
            <div class="email container">
                ...
                <form action="changepass.php" target="_self">
        ...
        <section class="accnotice container mb-3">
            <div class="accnotice">
                <div>
                    <h2>Account Notice: </h2>
                </div>
                <div class="spann">
                    <textarea name="account-note" id="account-note" cols="100" rows="8"></textarea>
                </div>
