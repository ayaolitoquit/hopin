    ...
    >
      ...
      <div class="content">
        <div class="d-flex flex-row">
          <div class="bg-success">
            ...
            <div class="applicants-overview d-flex justify-content-center text-white pt-2" id="totalApplicants"><?php echo isset($_SESSION['totalApplicants']) ? $_SESSION['totalApplicants'] : 0; ?></div>
          </div>
          <div class="bg-success">
            <h5 class="text-white text-center fw-bold mt-2">INTERVIEWING</h5>
            <div class="applicants-overview d-flex justify-content-center text-white pt-2" id="totalInterviewing"></div>
          </div>
          <div class="bg-success">
        ...
        <div class="process">
          <div class="d-flex flex-row">
            <div class="interviewing">
              <h5 class="text-center fw-bold mt-2">RECENT APPLICATIONS</h5>
            ...
            <div class="job-opening">
              ...
              <div class="d-flex flex-column text-center justify-content-center ml-4">
                <p>Full-Time</p>
                <p>Part-Time</p>
                <p>Internship</p>
              </div>
      ...
      <div class="donutChart position-absolute">
        ...
        // Data for the donut chart
          var data = {
          labels: ["Full-time", "Part-time", "Temporary"],
          datasets: [
            {
              data: [30, 40, 30], // Data values for each label
              backgroundColor: ["#617A55","#A4D0A4", "#F7E1AE"], // Colors for each segment
            },
          ],
        };
