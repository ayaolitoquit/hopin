...
function searchTable() {
  ...
  for (var i = 0; i < rows.length; i++) {
    var td = rows[i].querySelector(".tablink").previousElementSibling;
    // Change the index (0) to the column index you want to search in
...
function searchJobs() {
  ...
  window.location.href = 'jobs.php?search=' + encodeURIComponent(searchQuery);
}
